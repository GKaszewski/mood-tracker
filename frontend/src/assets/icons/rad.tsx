const RadIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width="72"
      height="72"
      ...
      {...props}
    >
      <rect width="72" height="72" fill="url(#pattern0_36_2222)" />
      <defs>
        <pattern
          id="pattern0_36_2222"
          ...
          height="1"
        >
          <use xlinkHref="#image0_36_2222" transform="scale(0.0138889)" />
        </pattern>
        <image
          id="image0_36_2222"
          width="72"
